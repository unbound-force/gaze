...
- [x] T011 [P] [US1] Create `internal/classify/godoc_test.go` with table-driven tests for `AnalyzeGodocSignal` covering: each contractual keyword ("returns", "sets", "writes", "sends", "creates", "deletes", "updates", "modifies", "stores") paired with matching `effectType` (+15 weight), and non-matching effectType (0 weight) (FR-004)
