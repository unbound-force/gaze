...
//
// The returned ContractCoverage.GapHints slice is parallel to Gaps:
// len(GapHints) == len(Gaps) is an enforced postcondition. Each hint
// is a Go code snippet generated by hintForEffect.
func ComputeContractCoverage(
	...
	for _, e := range effects {
		...
		if assertedIDs[e.ID] {
			...
			gaps = append(gaps, e)
			gapHints = append(gapHints, hintForEffect(e))
		}
	}
